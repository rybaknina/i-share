...
public class ClosedOrdersForPeriodByPrice implements IAction {
    private final static Logger logger = LogManager.getLogger(ClosedOrdersForPeriodByPrice.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByPrice(), OrderStatus.CLOSE, startDate, endDate).forEach(System.out::println);
