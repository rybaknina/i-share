...
public class LoadToFileAction implements IAction {
    ...
    public void execute() throws IOException {
        try {
            SerializeUtil.serialize(GarageController.getInstance().getGarages(),
                    MechanicController.getInstance().getMechanics(),
                    OrderController.getInstance().getOrders(),
                    SpotController.getInstance().getSpots(),
                    ToolController.getInstance().getTools());
