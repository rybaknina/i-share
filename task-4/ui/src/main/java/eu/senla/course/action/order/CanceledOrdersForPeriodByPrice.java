...
public class CanceledOrdersForPeriodByPrice implements IAction {
    private final static Logger logger = LogManager.getLogger(CanceledOrdersForPeriodByPrice.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByPrice(), OrderStatus.CANCEL, startDate, endDate).forEach(System.out::println);
