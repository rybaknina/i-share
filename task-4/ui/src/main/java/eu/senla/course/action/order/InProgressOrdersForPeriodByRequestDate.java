...
public class InProgressOrdersForPeriodByRequestDate implements IAction {
    private final static Logger logger = LogManager.getLogger(InProgressOrdersForPeriodByRequestDate.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByRequestDate(), OrderStatus.IN_PROGRESS, startDate, endDate).forEach(System.out::println);
