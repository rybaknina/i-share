...
public class ClosedOrdersForPeriodByPlannedDate implements IAction {
    private final static Logger logger = LogManager.getLogger(ClosedOrdersForPeriodByPlannedDate.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByPlannedDate(), OrderStatus.CLOSE, startDate, endDate).forEach(System.out::println);
