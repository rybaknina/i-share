...
public class InProgressOrdersForPeriodByPrice implements IAction {
    private final static Logger logger = LogManager.getLogger(InProgressOrdersForPeriodByPrice.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByPrice(), OrderStatus.IN_PROGRESS, startDate, endDate).forEach(System.out::println);
