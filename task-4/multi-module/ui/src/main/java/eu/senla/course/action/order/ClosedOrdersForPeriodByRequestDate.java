...
public class ClosedOrdersForPeriodByRequestDate implements IAction {
    private final static Logger logger = LogManager.getLogger(ClosedOrdersForPeriodByRequestDate.class);
