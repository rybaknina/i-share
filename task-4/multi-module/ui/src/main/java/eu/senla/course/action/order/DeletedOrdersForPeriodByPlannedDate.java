...
public class DeletedOrdersForPeriodByPlannedDate implements IAction {
    private final static Logger logger = LogManager.getLogger(DeletedOrdersForPeriodByPlannedDate.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByPlannedDate(), OrderStatus.DELETE, startDate, endDate).forEach(System.out::println);
