...
public class InProgressOrdersForPeriodByPlannedDate implements IAction {
    private final static Logger logger = LogManager.getLogger(InProgressOrdersForPeriodByPlannedDate.class);
    ...
    public void execute() throws IOException {
        ...
        try {
            controller.ordersForPeriod(new ByPlannedDate(), OrderStatus.IN_PROGRESS, startDate, endDate).forEach(System.out::println);
